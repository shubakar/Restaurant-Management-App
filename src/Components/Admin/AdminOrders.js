...
class AdminOrders extends React.Component{
    ...
    render(){
        ...
        let orders=this.state.orders.map(curValue=><Order  id={curValue._id} bill={curValue.bill} deliveryCharge={curValue.deliveryCharge} totalCost={curValue.totalCost}  items={curValue.items} key={curValue._id} status={curValue.status} deliverTo={curValue.deliverTo} orderBy={curValue.orderBy} routeProps={this.props.routeProps} isEmployee={true}/>)
        return (
