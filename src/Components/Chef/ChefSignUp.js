...
import ChefSignUpDialogBox from "./ChefSignUpDialogBox";
    ...
    componentDidMount(){
        ...
        .then(res=>{
            if(res.data.isloggedin.loginstatus){
                this.props.routeProps.history.push("/chef");
            }
        })
    }
    handleChange = (event) => {
    ...
    render(){
        ...
        return(
            <div className={classes.root}>
                ...
                {
                    this.state.dialogStatus && <ChefSignUpDialogBox text={this.state.dialogText} closeDialogBox={this.closeDialogBox}/>
                }
            </div>
